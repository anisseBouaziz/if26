...
public class InfoDialogFragment extends DialogFragment {
	...
	private boolean closeActivityOnOKClick;
	
	public InfoDialogFragment(String messageToDisplay) {
		super();
		this.messageToDisplay = messageToDisplay;
		closeActivityOnOKClick=false;
	}
	
	public InfoDialogFragment(String messageToDisplay,boolean closeActivityOnOKClick) {
		super();
		this.messageToDisplay = messageToDisplay;
		this.closeActivityOnOKClick=closeActivityOnOKClick;
	}
